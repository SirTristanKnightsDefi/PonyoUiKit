...
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav, toggleTheme = _a.toggleTheme, isDark = _a.isDark, cakePriceUsd = _a.cakePriceUsd; _a.tablePriceUsd; var legendPriceUsd = _a.legendPriceUsd; _a.squirePriceUsd; _a.shillingPriceUsd; _a.currentLang; _a.langs; _a.setLang;
    if (!isPushed) {
    ...
    return (React__default['default'].createElement(Container, null,
        ...
        React__default['default'].createElement(SocialEntry, null, legendPriceUsd ? (React__default['default'].createElement(PriceLink, { href: "", target: "_blank" },
            React__default['default'].createElement("img", { src: "https://metaclubbers.mypinata.cloud/ipfs/QmUnmRb5GsQux1nESaNLcGQEQavd9TCFapG7ucR5BBJA33", alt: "Ponyo Logo", style: {
                    width: "24px",
                    marginRight: "8px",
                } }),
            React__default['default'].createElement(Text, { color: "textSubtle", bold: true }, "$" + legendPriceUsd.toFixed(4)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 },
            React__default['default'].createElement("img", { src: "https://metaclubbers.mypinata.cloud/ipfs/QmUnmRb5GsQux1nESaNLcGQEQavd9TCFapG7ucR5BBJA33", alt: "Ponyo Logo", style: {
                    width: "24px",
                    marginRight: "8px",
                } })))),
...
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#1a295d", background: "#100C18", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#1a295d", tertiary: "#353547", text: "#c4e8fe", textDisabled: "#666171", textSubtle: "#8dc1ff", borderColor: "#524B63", card: "#27262c", gradients: {
